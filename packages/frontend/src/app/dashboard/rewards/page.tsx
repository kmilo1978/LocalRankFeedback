...
export default function RewardsPage() {
  ...
  const mockConfig = {
    ...
    rewardDescription: 'Disfruta un cafe gratis en tu proxima visita como agradecimiento por tu reseÒa',
    delayMinutes: 15,
    channel: 'whatsapp',
    expirationDays: 14,
    maxPerMonth: null,
      ...
      <div className="mb-6 rounded-lg border bg-blue-50 p-5 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-4">
          <div>
            ...
            <p className="text-sm font-medium text-gray-900">üéÅ {mockConfig.rewardTitle}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Se envia</p>
            <p className="text-sm font-medium text-gray-900">{mockConfig.delayMinutes} min despues de la reseÒa</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Canal</p>
            <p className="text-sm font-medium text-gray-900">üì± WhatsApp</p>
          </div>
          <div>
