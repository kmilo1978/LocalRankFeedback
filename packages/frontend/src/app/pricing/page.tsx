        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <PlanCard
            ...
            features={[
              ...
              { text: 'Respuestas IA a resenas', included: false },
          ...
          <PlanCard
            ...
            features={[
              ...
              { text: 'Respuestas IA a resenas de Google', included: true },
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="mt-10 space-y-6">
            ...
            <FaqItem
              ...
              answer="Es el filtro inteligente que decide hacia donde va cada feedback. Si el cliente da 4 o 5 estrellas, lo dirigimos a Google para que deje una resena publica. Si da 1 a 3, capturamos su opinion de forma privada y te alertamos para que lo contactes."
            />
            <FaqItem
