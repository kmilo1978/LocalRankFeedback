    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            ...
            <span className="text-blue-600">resenas de 5 estrellas</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
            Captura el feedback de tus pacientes y clientes al salir. Los satisfechos van directo a Google. 
            Los insatisfechos te llegan a ti por WhatsApp para que los recuperes antes de que publiquen una resena negativa.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-gray-600">
              Los negocios locales pierden clientes por resenas negativas que pudieron evitarse con una simple conversacion a tiempo.
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-yellow-100 bg-white p-6">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Los clientes satisfechos se van sin dejar resena. Tu competencia tiene mas reviews y se lleva los nuevos pacientes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-4">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Va directo a Google a dejar su resena publica. Tu rating sube.
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <BenefitCard
              icon="⭐"
              stat="+300%"
              title="Mas resenas en Google"
              description="Negocios que usan LocalRank triplican sus resenas de 5 estrellas en los primeros 60 dias."
            />
            <BenefitCard
              icon="🛡️"
              stat="85%"
              title="Resenas negativas evitadas"
            ...
            <BenefitCard
              ...
              description="Mejor rating + mas resenas + referidos = mas pacientes nuevos cada mes."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3">
            <TestimonialCard
              quote="En 2 meses pasamos de 12 a 47 resenas en Google. El rating subio de 3.8 a 4.6. Los pacientes nuevos mencionan que nos encontraron por las resenas."
            ...
            />
            <TestimonialCard
              quote="Antes pediamos resenas de forma manual y era incomodo. Ahora el QR hace todo el trabajo. Tenemos 4.8 estrellas con 200+ resenas."
              name="Andrea Ruiz"
